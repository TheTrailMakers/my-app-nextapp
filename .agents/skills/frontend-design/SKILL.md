...
- **Tone**: Pick an extreme: brutally minimal, play with lines, organic/natural, luxury/refined, art deco/geometric, soft/pastel.
- **Constraints**: Technical requirements (framework, performance, accessibility).
- **Differentiation**: What makes this UNFORGETTABLE? What's the one thing someone will remember?

**CRITICAL**: Choose a clear conceptual direction and execute it with precision. Refined minimalism works—the key is intentionality, not intensity.
