...
const nextConfig = {
  images: {
    remotePatterns: [
      ...
      { protocol: 'https', hostname: 'www.thegreatoutdoorsmag.com', pathname: '**' },
      ...
      { protocol: 'https', hostname: 'www.plasticsoupfoundation.org', pathname: '**' },
  ...
  async redirects() {
    return [
      { source: '/beas-kund-trek', destination: '/treks/beas-kund-trek', permanent: true },
      { source: '/bhrigu-lake-trek', destination: '/treks/bhrigu-lake-trek', permanent: true },
      { source: '/ranisui-lake-trek', destination: '/treks/ranisui-lake-trek', permanent: true },
    ];
  },
};
