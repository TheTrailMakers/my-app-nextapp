    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 shadow">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Manage your account and bookings</p>
        </div>
      </div>
                ...
                {bookings.map((booking) => (
                  <div key={booking.id} className="p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                      <div>
                        <p className="text-gray-600 dark:text-gray-400 text-xs font-medium">Travelers</p>
                        <p className="text-gray-900 dark:text-white font-semibold">{booking.numberOfPeople}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        <p className="text-gray-600 dark:text-gray-400 text-xs font-medium">Name</p>
                        <p className="text-gray-900 dark:text-white font-semibold">{booking.contactName}</p>
                      </div>
                      <div>
                        <p className="text-gray-600 dark:text-gray-400 text-xs font-medium">Phone</p>
                        <p className="text-gray-900 dark:text-white font-semibold">{booking.contactPhone}</p>
                      </div>
                    </div>
