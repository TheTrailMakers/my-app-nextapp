      ...
      <div className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Learn outdoor skills from certified instructors. Our hands-on courses cover rock climbing,
            mountaineering techniques, and wilderness survival skills.
          </p>
        </div>
      </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4 text-sm">
                      <div>
                        ...
                        <p className="font-semibold text-gray-900 dark:text-white">{course.duration} days</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900 dark:text-white text-xs">{course.location}</p>
                      </div>
                    </div>
