...
const blogPosts = [
  {
    ...
    excerpt: "Discover the most scenic and challenging treks in the beautiful Himachal Pradesh region.",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1551362185-acf8f42d8e8d?w=800&h=400&fit=crop",
    date: "Feb 15, 2026",
  ...
  },
  {
    ...
    excerpt: "Experience the breathtaking views and adventure of the Sandakphu Trek in the eastern Himalayas.",
    image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=400&fit=crop",
    date: "Feb 5, 2026",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <div className="px-4 py-12 border-b border-gray-800">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-gray-400">Insights, guides, and stories from our trekking adventures</p>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-20 bg-gradient-to-r from-blue-900 to-blue-600 rounded-lg p-12 text-center">
            ...
            <p className="text-lg text-gray-100 mb-8 max-w-2xl mx-auto">
              We'd love to hear about your trekking experiences and adventures. Get in touch with us!
            </p>
            <Link href="/contact" className="inline-block bg-white text-blue-600 font-bold px-8 py-3 rounded-lg hover:bg-gray-100 transition">
              Contact Us
            </Link>
          </div>
        </div>
