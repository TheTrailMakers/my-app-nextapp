      ...
      <section className='bg-black md:px-[calc((100vw-600px)/2)]'>
        ...
        <div className='mx-[10%] py-20'>
          ...
          <Accordion 
            ...
            answer=" No, the Bhrigu Lake Trek cannot be completed in one day. 
            It typically takes 3-4 days to complete the trek, depending on 
            the route chosen and the trekking pace. The trek involves covering 
            a distance of around 25-30 kilometers round trip, which requires 
            spending at least a couple of nights camping or staying in tents 
            along the trail."/>
