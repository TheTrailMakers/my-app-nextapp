    ...
    <section className="py-24 md:py-32 px-6 lg:px-12 bg-linear-to-b from-background to-muted relative">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-24 gap-8">
          ...
          <ScrollReveal animation="slide-left" className="text-muted-foreground text-base md:text-lg max-w-sm md:text-right border-l-2 md:border-l-0 md:border-r-2 border-primary/30 pl-4 md:pl-0 md:pr-4">
            <p>
