      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-16 pb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 md:gap-10 mb-12">
          ...
          <div className="min-w-0">
            <h5 className="font-bold text-foreground mb-4 text-base md:text-lg">Booking</h5>
            <nav className="space-y-3 text-xs md:text-sm">
              <div>
                <Link
                  href="/booking/my-bookings"
                  className="hover:text-primary transition wrap-break-word"
                >
                  My Bookings
                </Link>
              </div>
          ...
          {/* Company */}
          <div className="min-w-0">
            <h5 className="font-bold text-foreground mb-4 text-base md:text-lg">Company</h5>
            <nav className="space-y-3 text-xs md:text-sm">
              <div>
                <Link
          ...
          {/* Contact */}
          <div className="min-w-0">
            <h5 className="font-bold text-foreground mb-4 text-base md:text-lg">Contact</h5>
            <nav className="space-y-3 text-xs md:text-sm">
              <div>
                <Link
          ...
          <div className="sm:col-span-2 md:col-span-2 lg:col-span-2 min-w-0">
            <h5 className="font-bold text-foreground mb-4 text-base md:text-lg">The Mission</h5>
        ...
        <div className="border-t border-border pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap gap-4 md:gap-6 justify-center">
              <Link href="/contact" className="text-xs md:text-sm hover:text-primary transition">
                Privacy Policy
              </Link>
              <Link href="/contact" className="text-xs md:text-sm hover:text-primary transition">
                Terms of Service
