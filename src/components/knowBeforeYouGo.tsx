    ...
    <section className="py-24 md:py-32 px-6 lg:px-12 bg-linear-to-b from-background to-muted border-t border-border">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          ...
          <ScrollReveal animation="slide-left" offset={["start 95%", "start 80%"]}>
            <Link href="/lessons">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          ...
          <ScrollReveal animation="fade-up" offset={["start 95%", "start 60%"]} className="lg:col-span-7">
          ...
          <div className="lg:col-span-5 flex flex-col gap-12">
            {secondary.map((article, idx) => (
              <ScrollReveal key={idx} animation="fade-up" offset={["start 95%", "start 75%"]}>
                <div
