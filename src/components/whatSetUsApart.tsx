  ...
  const features = [
    {
      ...
      description: "Rigorous protocols so you can embrace the wild without fear.",
    },
    {
      title: "Local Knowledge",
      description: "Guides who grew up on these trails, sharing their untamed home.",
    },
    {
      title: "Uncompromised Quality",
      description: "From premium tents to curated meals, comfort meets the wilderness.",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1 flex flex-col justify-center">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-unwrap lg:text-6xl font-display font-medium text-foreground leading-[1.15] mb-8">
              We Don't Just Guide. We <span className="italic text-primary/80">Transform</span>.
            </h2>
            
            <p className="text-muted-foreground text-lg leading-relaxed mb-12 font-body max-w-md">
              A trek isn't just about reaching a summit; it's about the rhythm of your boots on dirt, the bite of alpine air, and the stories shared by a campfire. We strip away the noise to let nature speak.
            </p>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 relative h-[600px] md:h-[800px] w-full rounded-sm overflow-hidden group">
            <Image
